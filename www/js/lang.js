var languageDesObject = {
	'vi': {
		...
		'GetAgencyCodePrompt': 'Vui lòng lấy mã xác nhận từ trang quản lý đại lý',
	...
	'en': {
		...
		'GetAgencyCodePrompt': 'Please get confirmation code from agency\'s tool website',
	...
	'lo': {
		...
		'GetAgencyCodePrompt': 'Please logging in the game, open your profile page, click REG APP OTP button then follow the instruction to get confirmation code',
